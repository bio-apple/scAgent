...
LangGraph agent for single-cell bioinformatics: **tissue-aware QC, execution review, auditable scripts**. **99** bundled skills; [`knowledge/`](README.en.md#knowledge-base) fused RAG + structured KB (CL, markers, pathways, disease signatures, tissue maps).
