...
_PHRASES: tuple[tuple[str, str], ...] = (
    ...
    ("差异表达", "differential expression deg pseudobulk deseq edger mast wilcoxon t-test"),
    ...
    ("轨迹分析", "trajectory paga palantir scvelo pseudotime monocle3"),
    ("细胞命运", "cell fate palantir pseudotime velocity"),
    ("rna velocity", "scvelo unspliced spliced velocity"),
