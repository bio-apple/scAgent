...
**Upstream**: https://github.com/jaechang-hits/SciAgent-Skills/blob/main/legacy/single-cell-annotation/SKILL.md
...
- `single-cell-annotation-guide` — this repo's three-tier SOP (manual markers → CellTypist → popV); use together, do not treat Azimuth-only as sufficient
- `celltypist-cell-annotation` — automated logistic-regression annotation
- `popv-cell-annotation` — ensemble label transfer
- `scanpy-scrna-seq` — QC → clustering foundation before annotation
- `harmony-batch-correction` — correct batches before assigning labels
