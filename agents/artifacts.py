...
FIGURE_CAPTIONS = {
    ...
    "marker_heatmap": "探索性 cluster marker 热图（top genes × clusters）。不是组间结论。",
    "volcano": "组间 pseudobulk DEG 火山图（logFC vs -log10 p）。须配合 FDR 解读。",
    "pathway_bubble": "通路富集气泡图（ORA/GSEA top terms；-log10 p 与 overlap 大小）。",
