...
If the query compares conditions, set intent deg / condition_comparison and the DAG will pull in annotation first (groupby required).
Do not treat "degradation", "degree", or "edge detection" as differential expression.
