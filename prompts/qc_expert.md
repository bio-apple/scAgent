...
Heart/kidney/tumor: wider MAD. Follow fused RAG hits from `knowledge/best_practices/qc.md` and tissue-aware SOPs when present. Output a protocol in Chinese. Do not choose R vs Python; Tool Router will pick Seurat first, Scanpy only as backup.
